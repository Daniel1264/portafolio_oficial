        ...
        <div className="sm:w-1/2 w-full flex flex-col gap-3 p-3">
            ...
            <form className="flex flex-col justify-between h-full gap-3">
                <div className="flex flex-col">
                    ...
                    <input type="text" id="name" placeholder="nombre" className="bg-transparent p-3 duration-300 outline-none border-b-2 dark:border-wallpepercolor dark:focus:border-white" />
                </div>
                <div className="flex flex-col">
                    <label htmlFor="email" className="text-wallpepercolor text-xl font-medium dark:text-white">Correo</label>
                    <input type="email" id="email" placeholder="correo" className="dark:bg-transparent p-3 duration-300 outline-none border-b-2 dark:border-wallpepercolor dark:focus:border-white"  />
                </div>
                <div className="flex flex-col">
                    <label htmlFor="mensaje" className="text-wallpepercolor text-xl font-medium dark:text-white">Mensaje</label>
                    <textarea placeholder="escribe tu mensaje" id="mensaje" rows="6" cols="50" className="dark:bg-transparent border-b-2 dark:border-wallpepercolor dark:focus:border-white outline-none"></textarea>
                </div>
